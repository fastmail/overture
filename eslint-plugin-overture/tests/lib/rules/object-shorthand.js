...
const LONGFORM_METHOD_CONSTRUCTOR_ERROR = { message: "Expected longform method syntax for constructor.", type: "Property" };
...
ruleTester.run("object-shorthand", rule, {
    valid: [
        ...
        {
            code: "({ constructor: function () {}, foo () {} })",
            options: ["always", { constructors: { pattern: "^constructor$" } }]
        },
        {
            code: "({ constructor () {}, foo () {} })",
            options: ["always", { constructors: { pattern: "^constructor$", ignore: true } }]
        }
    ],
    invalid: [
        {
        ...
        {
            code: "({ constructor () {}, foo () {} })",
            output: "({ constructor: function () {}, foo () {} })",
            options: ["always", { constructors: { pattern: "^constructor$" } }],
            errors: [LONGFORM_METHOD_CONSTRUCTOR_ERROR]
        },
        {
            code: "({ constructor () {}, foo: function () {} })",
            output: "({ constructor () {}, foo () {} })",
            options: ["always", { constructors: { pattern: "^constructor$", ignore: true } }],
            errors: [METHOD_ERROR]
        }
    ]
